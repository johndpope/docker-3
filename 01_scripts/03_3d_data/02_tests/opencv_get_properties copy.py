...
img_real_dir = fr"P:\MB\Labore\Robotics\019_ChewRob\99_Homes\bra45451\depo\docker\data\einzelzahn\images\testimg\{folder}\rgb\{grid_size}x{grid_size}\img"
...
img_paths = sorted(glob.glob(os.path.join(img_real_dir, "*.png")))

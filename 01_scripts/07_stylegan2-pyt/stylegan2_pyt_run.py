...
home_path = "/home"
p_base_path = f"/home/proj_depo/docker/models/stylegan2"
...
params['kimg'] = 10000
params['metrics'] = None
# params['pkl_url'] = "https://nvlabs-fi-cdn.nvidia.com/stylegan2-ada-pytorch/pretrained/transfer-learning-source-nets/ffhq-res256-mirror-paper256-noaug.pkl"
params['pkl_url'] = "https://nvlabs-fi-cdn.nvidia.com/stylegan2-ada/pretrained/transfer-learning-source-nets/celebahq-res256-mirror-paper256-kimg100000-ada-target0.5.pkl"
...
if util.ask_yes_no("Create new folder <date>_<pkl-name>? "):
    ...
    folder = f"{today_var}_{os.path.basename(params['pkl_url']).split('.pkl')[-2].replace('.','_')}"

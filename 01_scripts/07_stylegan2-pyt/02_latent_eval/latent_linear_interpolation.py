...
#  --interpolation="slerp"
os.system(f'python {os.path.join(stylegan_path, "generate.py")} --outdir=out/slerp-z/ --space="z" --trunc=1 --process="interpolation" --seeds=85,265,297,849 --network={paths["network_pkl_path"]} --frames=24')
...
#     os.system(f'python {os.path.join(stylegan_path, "generate.py")} --outdir=out/slerp-z/ --space="z" --trunc=1 --process="interpolation" --interpolation="slerp" --seeds=85,265,297,849 --network={network_pkl} --frames=24')

...
def init_network2(network_pkl, truncation_psi=0.5, noise_var_seed = 0, outdir=None):
...
def generate_image2(Gs, Gs_kwargs, label, seed, outdir=None, dlatents_npz=None):

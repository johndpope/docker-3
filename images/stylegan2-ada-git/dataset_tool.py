...
def create_from_np(tfrecord_dir, np_path, shuffle):
    print('Loading images from "%s"' % np_path)
...
def execute_cmdline(argv):
    ...
    p = add_command(    'create_from_np',   'Create dataset from a .npy file with images.',
                                            'create_from_images datasets/mydataset myimagedir')
    p.add_argument(     'tfrecord_dir',     help='New dataset directory to be created')
    p.add_argument(     'np_path',          help='Path to npy File')
